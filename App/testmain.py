    ...
    try:
        while True:
            ...
            if flag==0:
                ...
                #store this answer variable to database as bot response
                bot_response = answer
            ...
            #STORE TRANSCRIPT AND ANSWER TO DATABASE as user response and bot response respectively and also store the id_ to the database as sesssion id
